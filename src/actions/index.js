import {
    ADD_PHONE_TO_BASKET, CLEAN_BASKET, FETCH_CATEGORIES_FAILURE, FETCH_CATEGORIES_START, FETCH_CATEGORIES_SUCCESS,
    ...
    LOAD_MORE_PHONES_SUCCESS, REMOVE_PHONE_FROM_BASKET, SEARCH_PHONE
} from "../actionTypes";
import {
...
export const basketCheckout = phones => () => {
    window.alert(JSON.stringify(phones))
}
